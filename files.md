...
| `tests/e2e/scraper.test.js` | E2E tests - full pipeline with real careers page, ANAF, and SOLR |
...
- Full workflow: validate company (ANAF+Peviitor) → scrape West Company → transform → upsert SOLR → generate docs/jobs.md
